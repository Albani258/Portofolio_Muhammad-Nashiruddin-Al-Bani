<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="<?php echo e(url('admin/')); ?>" class="block">
    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <div class="flex items-center gap-3">
            ...
            <div
                class="w-10 h-10 rounded-full bg-gradient-to-br from-[#D4A017] to-[#B8920E] flex items-center justify-center shadow-md">
                ...
                <ul class="flex flex-col gap-1">
                    <li x-data="{ open: false }">
                        ...
                        <div x-show="open"
                            ...
                            <a href="<?php echo e(url('admin/akun')); ?>"
                                class="flex items-center rounded-lg px-3 py-2 text-xs text-white/50 hover:bg-white/10 hover:text-white transition-all">
                                Akun
                            </a>

                            <a href="<?php echo e(url('admin/akun/create')); ?>"
                                class="flex items-center rounded-lg px-3 py-2 text-xs text-white/50 hover:bg-white/10 hover:text-white transition-all">
                                Tambah Akun
                            </a>
                        </div>
    ...
    <div class="mt-auto p-4 border-t border-white/10">
        <div class="text-center">
            ...
            <p class="text-[10px] text-white/20 mt-2">&copy; 2026</p>
        </div>
    </div>
</aside>
...
</style><?php /**PATH E:\RUMGABPSDMIMIPAS\RUMGABPSDMIMIPAS\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>