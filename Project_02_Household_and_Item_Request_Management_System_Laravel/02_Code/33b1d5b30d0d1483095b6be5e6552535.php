...
<div class="premium-card shadow-xl">
    <div class="flex flex-wrap items-center justify-between gap-4 border-b border-gray-100 px-6 py-5 bg-gradient-to-r from-white to-gray-50">
        ...
        <form id="filterForm" method="GET" action="<?php echo e(route('admin.pengajuan.index')); ?>"
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-[#F5E6B8]/20 transition-all duration-200">
                    <td class="px-6 py-4 text-sm text-gray-500">
                        <?php echo e($pengajuan->firstItem() + $key); ?>

                    </td>

                    <td class="px-6 py-4 text-sm font-semibold text-gray-700">
                        <?php echo e($namaPengaju); ?>
                    ...
                    <td class="px-6 py-4 text-sm font-semibold text-gray-700">
                        <?php echo e($item->jumlah_pengajuan ?? 0); ?> <?php echo e($satuan); ?>
                    ...
                    <td class="px-6 py-4">
                        <?php if($status === 'Disetujui semua'): ?>
                        <span class="badge-success cursor-pointer">✅ Disetujui semua</span>
                        <?php elseif($status === 'Disetujui sebagian'): ?>
                    ...
                    <td class="px-6 py-4">
                        <button type="button"
                            onclick="openModal('modalDetail<?php echo e($item->id); ?>')"
                ...
                <div id="modalDetail<?php echo e($item->id); ?>"
                    ...
                    <div class="w-full max-w-3xl max-h-[92vh] overflow-y-auto rounded-3xl bg-white shadow-2xl">
                        ...
                        <div class="sticky top-0 z-10 bg-gradient-to-r from-[#0B3B5F] to-[#0A2E4A] px-6 py-5">
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <button type="button"
                                    onclick="closeModal('modalDetail<?php echo e($item->id); ?>')"
                        ...
                        <div class="p-6">
                                ...
                                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">
                                            <?php echo e($kodeBarang); ?> • <?php echo e($kategori); ?>
                            ...
                            <div class="grid gap-4 md:grid-cols-2">
                                <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
                                    ...
                                    <p class="mt-1 text-sm font-bold text-gray-800"><?php echo e($namaPengaju); ?></p>
                                </div>

                                <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
                                    <p class="text-xs text-gray-400">Divisi Pengaju</p>
                                    <p class="mt-1 text-sm font-bold text-gray-800"><?php echo e($divisiPengaju); ?></p>
                                </div>

                                <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
                                    <p class="text-xs text-gray-400">Kode Barang</p>
                                    <p class="mt-1 text-sm font-bold font-mono text-[#0B3B5F]"><?php echo e($kodeBarang); ?></p>
                                </div>

                                <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
                                    <p class="text-xs text-gray-400">Nama Barang</p>
                                    <p class="mt-1 text-sm font-bold text-gray-800"><?php echo e($namaBarang); ?></p>
                                </div>

                                <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
                                    <p class="text-xs text-gray-400">Stok Tersedia</p>
                                    <p class="mt-1 text-sm font-bold text-gray-800">
                                        <?php echo e($stokTersedia); ?> <?php echo e($satuan); ?>
                                ...
                                <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
                                    ...
                                    <p class="mt-1 text-sm font-bold text-gray-800">
                                        <?php echo e($item->jumlah_pengajuan); ?> <?php echo e($satuan); ?>
                            ...
                            <?php if(!$isProcessed): ?>
                            <form action="<?php echo e(route('admin.pengajuan.updateStatus', $item->id)); ?>" method="POST"
                                ...
                                <div class="mb-4 grid gap-3 rounded-xl bg-white p-4 text-sm md:grid-cols-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-gray-800">
                                            <?php echo e(min($item->jumlah_pengajuan, $stokTersedia)); ?> <?php echo e($satuan); ?>

                                        </p>
                                    </div>
                                </div>

                                <?php if($stokTersedia < $item->jumlah_pengajuan): ?>
                                    <div class="mb-4 rounded-xl border border-yellow-200 bg-yellow-50 p-4 text-sm text-yellow-800">
                                        ...
                                        <strong><?php echo e($stokTersedia); ?> <?php echo e($satuan); ?></strong>.
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="aksi_persetujuan"
                                            id="aksi_persetujuan_<?php echo e($item->id); ?>"
                                            onchange="togglePersetujuanForm('<?php echo e($item->id); ?>')"
                                            required
                                    ...
                                    <div id="partial_box_<?php echo e($item->id); ?>"
                                        ...
                                        <input type="number"
                                            ...
                                            id="jumlah_disetujui_<?php echo e($item->id); ?>"
                                            min="1"
                                            max="<?php echo e(min($item->jumlah_pengajuan, $stokTersedia)); ?>"
                                        ...
                                        <p class="mt-2 text-xs text-gray-500">
                                            Maksimal:
                                            <strong><?php echo e(min($item->jumlah_pengajuan, $stokTersedia)); ?> <?php echo e($satuan); ?></strong>
                                        </p>
                                    </div>

                                    <div id="reject_box_<?php echo e($item->id); ?>"
                                        ...
                                        <textarea name="alasan_penolakan"
                                            id="alasan_penolakan_<?php echo e($item->id); ?>"
                                            rows="3"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mclarens-username/Downloads/BMN-VS2/resources/views/admin/pengajuan/index.blade.php ENDPATH**/ ?>