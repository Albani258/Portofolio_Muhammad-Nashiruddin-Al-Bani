<?php $__env->startSection('title', 'Daftar Pengadaan Barang'); ?>
...
<div class="premium-card shadow-xl bg-white overflow-hidden rounded-2xl border border-gray-200">
    <div class="flex flex-wrap items-center justify-between gap-4 border-b border-gray-100 px-6 py-5 bg-gradient-to-r from-white to-gray-50/50">
        ...
        <form method="GET" action="<?php echo e(route('user.pengadaan.index')); ?>" class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100 font-medium text-gray-700 bg-white">
                <?php $__empty_1 = true; $__currentLoopData = $pengadaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-[#F5E6B8]/10 transition-colors">
                    <td class="px-6 py-4 text-center font-bold text-gray-400">
                        <?php echo e($pengadaan->firstItem() + $key); ?>
                    ...
                    <td class="px-6 py-4 text-center">
                        ...
                        <?php elseif(($item->prioritas ?? '-') == 'Sedang'): ?>
    ...
    <div class="border-t border-gray-100 px-6 py-4 bg-gray-50/40">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <p class="text-sm text-gray-500 font-medium">
                Menampilkan 
                <strong class="text-[#0B3B5F] font-bold"><?php echo e($pengadaan->firstItem() ?? 0); ?></strong> 
                sampai 
                <strong class="text-[#0B3B5F] font-bold"><?php echo e($pengadaan->lastItem() ?? 0); ?></strong> 
                dari 
                <strong class="text-[#0B3B5F] font-bold"><?php echo e($pengadaan->total()); ?></strong> 
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mclarens-username/Downloads/BMN-VS2/resources/views/user/pengadaan/index.blade.php ENDPATH**/ ?>