<?php $__env->startSection('title', 'Pengadaan Barang'); ?>
...
<div class="premium-card shadow-xl">
    ...
    <div class="p-8">
        ...
        <form action="<?php echo e(route('admin.pengadaan.store')); ?>" method="POST" id="formPengadaan">
            <?php echo csrf_field(); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="stock_id"
                        ...
                        <option value="<?php echo e($item->id); ?>"
                            data-nama="<?php echo e($item->nama_barang); ?>"
                            data-kode="<?php echo e($item->kode_barang); ?>"
                            data-kategori="<?php echo e($item->kategori); ?>"
                            data-jumlah="<?php echo e($item->jumlah_stock); ?>"
                            data-satuan="<?php echo e($item->satuan); ?>"
                            data-minimal="<?php echo e($item->minimal_stock); ?>"
                            data-lokasi="<?php echo e($item->lokasi); ?>">
                            <?php echo e($item->nama_barang); ?> - <?php echo e($item->kode_barang); ?>
            ...
            <div id="formNew" class="hidden grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="satuan"
                        ...
                        <option value="<?php echo e($satuan); ?>" <?php echo e(old('satuan', 'Pcs') == $satuan ? 'selected' : ''); ?>>
                            <?php echo e($satuan); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mclarens-username/Downloads/BMN-VS2/resources/views/admin/pengadaan/create.blade.php ENDPATH**/ ?>