<header x-data="{menuToggle: false}"
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div class="flex w-full items-center justify-between gap-2 px-4 py-3 lg:justify-normal lg:px-0 lg:py-4">
            ...
            <!-- Logo Desktop -->
<a href="<?php echo e(url('user/')); ?>" class="hidden lg:flex lg:items-center lg:gap-4">
    ...
    <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col leading-tight">
            ...
            <!-- Logo Mobile -->
<a href="<?php echo e(url('user/')); ?>" class="lg:hidden flex items-center gap-2">
...
</style><?php /**PATH E:\RUMGABPSDMIMIPAS\RUMGABPSDMIMIPAS\resources\views/user/partials/header.blade.php ENDPATH**/ ?>