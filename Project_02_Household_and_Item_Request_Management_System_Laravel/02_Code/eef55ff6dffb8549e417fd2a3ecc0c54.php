<header x-data="{menuToggle: false}"
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div class="flex w-full items-center justify-between gap-2 px-4 py-3 lg:justify-normal lg:px-0 lg:py-4">
            ...
            <button
                :class="sidebarToggle ? 'bg-[#D4A017]/10 text-[#D4A017]' : 'text-gray-500 hover:bg-[#D4A017]/10 hover:text-[#D4A017]'"
            ...
            <!-- Logo Desktop -->
            <a href="<?php echo e(url('admin/')); ?>" class="hidden lg:flex lg:items-center lg:gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col leading-tight">
                        <span class="font-bold text-gray-800 dark:text-white text-sm tracking-wide">
            ...
            <!-- Logo Mobile -->
            <a href="<?php echo e(url('admin/')); ?>" class="lg:hidden flex items-center gap-2">
                <img
                    src="<?php echo e(asset('tailadmin/src/images/logo/logo-kemenimipas.png')); ?>"
                    alt="Logo Kemenimipas"
                ...
                <span class="font-bold text-[#0B3B5F] dark:text-white text-xs">
                    BPSDM KEMENIMIPAS
                </span>
            </a>
            ...
            <div class="flex items-center gap-2 ml-auto">
                ...
                <!-- Dark Mode -->
                <button
                    class="flex h-9 w-9 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-500 transition-all hover:bg-[#D4A017]/10 hover:text-[#D4A017] dark:border-gray-700 dark:bg-gray-800"
                    @click.prevent="darkMode = !darkMode">

                    <svg class="dark:hidden w-4 h-4"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24">
                    ...
                    <svg class="hidden dark:block w-4 h-4"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24">
                    ...
                    <div
                        ...
                        <div class="border-b border-gray-100 px-4 py-3 dark:border-gray-700">
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">
                                <?php echo e(auth()->user()->email ?? 'admin@bpsdm.imipas.go.id'); ?>
                ...
                <!-- Mobile Menu Button -->
                <button
                    class="flex h-9 w-9 items-center justify-center rounded-xl text-gray-500 hover:bg-[#D4A017]/10 hover:text-[#D4A017] lg:hidden"
...
</style><?php /**PATH E:\RUMGABPSDMIMIPAS\RUMGABPSDMIMIPAS\resources\views/admin/partials/header.blade.php ENDPATH**/ ?>