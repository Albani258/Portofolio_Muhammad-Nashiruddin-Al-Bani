<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="<?php echo e(url('user/')); ?>" class="flex items-center gap-2">
                ...
                <ul class="flex flex-col gap-1">
                    ...
                    <li>
                        <a href="<?php echo e(url('user/pengajuan')); ?>"
                            ...
                            <span :class="sidebarToggle ? 'lg:hidden' : ''" class="text-sm font-medium">Riwayat Pengajuan</span>
                        </a>
                    </li>
                    <!-- Tambah Pengajuan -->
                    <li>
                        <a href="<?php echo e(url('user/pengajuan/create')); ?>"
                            ...
                            <span :class="sidebarToggle ? 'lg:hidden' : ''" class="text-sm font-medium">Tambah Pengajuan Barang</span>
                        </a>
                    </li>
                    <!-- Riwayat Pengadaan -->
                    <li>
                        <a href="<?php echo e(url('user/pengadaan')); ?>"
                            ...
                            <span :class="sidebarToggle ? 'lg:hidden' : ''" class="text-sm font-medium">Riwayat Pengadaan</span>
                        </a>
                    </li>
                    <!-- Tambah Pengadaan -->
                    <li>
                        <a href="<?php echo e(url('user/pengadaan/create')); ?>"
                            ...
                            <span :class="sidebarToggle ? 'lg:hidden' : ''" class="text-sm font-medium">Tambah Pengadaan Barang</span>
                        </a>
                    </li>
                    <!-- Tambah Pengajuan -->
                    <!-- <li>
...
</style><?php /**PATH /home/mclarens-username/Downloads/BMN-VS2/resources/views/user/partials/sidebar.blade.php ENDPATH**/ ?>