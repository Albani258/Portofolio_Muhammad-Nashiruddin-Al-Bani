        ...
        <div class="flex items-center gap-3">
            ...
            <div :class="sidebarToggle ? 'lg:hidden' : ''">
                <p class="text-sm font-semibold text-white">
                    {{ Auth::user()->name ?? 'User BPSDM' }}
                </p>

                <p class="text-[10px] text-white/50">
                    {{ Auth::user()->divisi ?? 'User' }}
                </p>
            </div>
        </div>
                ...
                <ul class="flex flex-col gap-1">
                    ...
                    <li>
                        <a href="{{ url('user/pengajuan') }}"
                            ...
                            {{ request()->is('user/pengajuan') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                    ...
                    <!-- Tambah Pengajuan -->
                    <li>
                        <a href="{{ url('user/pengajuan/create') }}"
                            class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200
                            {{ request()->is('user/pengajuan/create') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                    ...
                    <!-- Riwayat Pengadaan -->
                    <li>
                        <a href="{{ url('user/pengadaan') }}"
                            class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200
                            {{ request()->is('user/pengadaan') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                    ...
                    <!-- Tambah Pengadaan -->
                    <li>
                        <a href="{{ url('user/pengadaan/create') }}"
                            class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200
                            {{ request()->is('user/pengadaan/create') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
