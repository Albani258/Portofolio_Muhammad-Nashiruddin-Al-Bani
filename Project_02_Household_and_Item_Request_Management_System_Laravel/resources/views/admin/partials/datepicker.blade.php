<div class="relative">
    <input class="datepicker w-full rounded-xl border-2 border-gray-200 bg-white py-2.5 pl-11 pr-4 text-sm font-medium text-gray-700 shadow-sm focus:border-[#D4A017] focus:outline-none focus:ring-2 focus:ring-[#D4A017]/20 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 transition-all" 
...
<script>
    // Fungsi untuk inisialisasi datepicker jika menggunakan Flatpickr
