<header x-data="{menuToggle: false}"
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div class="flex w-full items-center justify-between gap-2 px-4 py-3 lg:justify-normal lg:px-0 lg:py-4">
            ...
            <!-- Logo Desktop -->
            <a href="{{ url('admin/') }}" class="hidden lg:flex lg:items-center lg:gap-4">
                <div class="flex items-center gap-3">

                    <div class="w-12 h-12 flex items-center justify-center">
                        <img
                            src="{{ asset('tailadmin/src/images/logo/logo-kemenimipas.png') }}"
                    ...
                    <div class="w-11 h-11 flex items-center justify-center">
                        <img
                            src="{{ asset('tailadmin/src/images/logo/logo-bpsdm.png') }}"
                            alt="Logo BPSDM"
                            class="w-full h-full object-contain">
                    </div>
            ...
            <!-- Logo Mobile -->
            <a href="{{ url('admin/') }}" class="lg:hidden flex items-center gap-2">
                <img
                    src="{{ asset('tailadmin/src/images/logo/logo-kemenimipas.png') }}"
                    alt="Logo Kemenimipas"
                    ...
                    <div
                        ...
                        <div class="border-b border-gray-100 px-4 py-3 dark:border-gray-700">
                            <p class="font-semibold text-gray-800 dark:text-white">
                                {{ auth()->user()->name ?? 'Admin BPSDM' }}
                            </p>

                            <p class="text-xs text-gray-500 mt-0.5">
                                {{ auth()->user()->email ?? 'admin@bpsdm.imipas.go.id' }}
                            </p>
                        </div>
