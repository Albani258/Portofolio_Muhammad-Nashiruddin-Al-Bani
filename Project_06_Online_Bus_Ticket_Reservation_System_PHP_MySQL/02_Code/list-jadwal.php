...
<body>
    ...
    <nav>
        <a type='button' class='btn btn-success' href="tambah-jadwal.php">Tambah Data</a>
    </nav>
	...
	<thead>
        <tr>
            <!--<th class="text-center">#</th>-->
				...
				<th class="text-center">Kota Keberangkatan</th>
    ...
    <?php
        ...
        while($jadwal = mysqli_fetch_array($query)){
            ...
            echo "<td>".$jadwal['id_bus']."</td>";
            echo "<td>".$jadwal['kota_keberangkatan']."</td>";
            echo "<td>".$jadwal['tgl_berangkat']."</td>";
            echo "<td>".$jadwal['waktu_berangkat']."</td>";
            echo "<td>".$jadwal['kota_tujuan']."</td>";
            echo "<td>".$jadwal['tgl_tiba']."</td>";
            echo "<td>".$jadwal['waktu_tiba']."</td>";
            echo "<td>".$jadwal['harga_tiket']."</td>";
            

            echo "<td>";
            echo "<a type='button' class='btn btn-primary' href='form-edit-jadwal.php?id=".$jadwal['id_jadwal']."'>Edit</a> | ";
            echo "<a type='button' class='btn btn-danger'href='hapus_jadwal.php?id=".$jadwal['id_jadwal']."'>Hapus</a>";
            echo "</td>";
            echo "</tr>";
        }
        ?>
