...
<body>
    ...
    <nav>
        <a type='button' class='btn btn-success' href="tambah-admin.php">Tambah Data</a>
    </nav>
	...
	<thead class="">
        <tr>
            <!--<th class="text-center">#</th>-->
				<th class="text">ID Admin</th>
				<th class="text">Username</th>
				<th class="text">Password</th>
                <th class="text">Nama Admin</th>
    ...
    <?php
        ...
        while($admin = mysqli_fetch_array($query)){
            ...
            echo "<td>";
            echo "<a type='button' class='btn btn-primary' href='form-edit-admin.php?id=".$admin['id_admin']."'>Edit</a> | ";
            echo "<a type='button' class='btn btn-danger'href='hapus_admin.php?id=".$admin['id_admin']."'>Hapus</a>";
            echo "</td>";
            echo "</tr>";
        }
        ?>
