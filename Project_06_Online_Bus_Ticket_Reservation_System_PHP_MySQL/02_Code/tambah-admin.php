      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="list.php">Daftar admin</a></li>
            <li>Tambah admin</li>
          </ol>
        </div>
...
<?php
    // membuat id admin secara otomatis

    $getId = mysqli_query($db, "SELECT max(id_admin) as idTerbesar FROM tabel_admin");
    $data = mysqli_fetch_array($getId);
    $idadmin = $data['idTerbesar'];
    // mengambil angka dari id admin terbesar, menggunakan fungsi substr
...
<body>
    ...
    <form action="proses-tambah-admin.php" method="POST">
        ...
        <p>
            ...
            <input type="text" name="idadmin" required="required" value="<?php echo $idadmin ?>" readonly>
        </p>
        <p>
        ...
        <p>
            ...
            <input type="text" name="namaadmin" placeholder="Nama admin" />
        </p>
        <p>
